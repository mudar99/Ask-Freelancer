    ...
    return (
      <section id="skills" className="mt-5">
        <div className="container">
          ...
          <div className="row">{console.log(this.props.Skills)}
            {this.props.Skills.map((skill) => (
              <div key={skill.id} className="p-2 col-md-6">
                <div className="skills p-4 ">
                  <div hidden={this.props.myID != this.props.userID}><PencilIcon className="float-right" data-toggle="modal" data-target={`.modal-MakeTest${skill.id}`} cursor="pointer" color='gray' height={22} /></div>
                ...
                <ProgressBar className="rounded-0" value={skill.rate} color='#28a745' style={{ backgroundColor: 'lightgreen', height: '20px' }}></ProgressBar>
